...
- **Files to Create / Modify:**
  - `[NEW]` [backend/events/message_models.py](file:///Users/urjasoft/Documents/Recovery%20OS/backend/events/message_models.py)
  - `[NEW]` [backend/events/publisher.py](file:///Users/urjasoft/Documents/Recovery%20OS/backend/events/publisher.py)
  - `[NEW]` [backend/events/consumer.py](file:///Users/urjasoft/Documents/Recovery%20OS/backend/events/consumer.py)
  - `[MODIFY]` [backend/config.py](file:///Users/urjasoft/Documents/Recovery%20OS/backend/config.py)
...
- **Files to Create / Modify:**
  - `[NEW]` [backend/worker/service.py](file:///Users/urjasoft/Documents/Recovery%20OS/backend/worker/service.py)
  - `[MODIFY]` [backend/api/server.py](file:///Users/urjasoft/Documents/Recovery%20OS/backend/api/server.py) (Adds `/api/pubsub/consume` push endpoint)
  - `[MODIFY]` [backend/persistence/workflow_store.py](file:///Users/urjasoft/Documents/Recovery%20OS/backend/persistence/workflow_store.py) (Adds message deduplication tracking)
...
- **Files to Create / Modify:**
  - `[NEW]` [backend/llm/distributed_limiter.py](file:///Users/urjasoft/Documents/Recovery%20OS/backend/llm/distributed_limiter.py)
  - `[MODIFY]` [backend/llm/resilience.py](file:///Users/urjasoft/Documents/Recovery%20OS/backend/llm/resilience.py)
...
- **Files to Create / Modify:**
  - `[MODIFY]` [Dockerfile](file:///Users/urjasoft/Documents/Recovery%20OS/Dockerfile)
